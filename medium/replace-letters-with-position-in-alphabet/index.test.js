import alphabetIndex from './index';

describe('Javascript - Medium - 25', () => {
  test('Replace Letters With Position In Alphabet', () => {
    expect(
      alphabetIndex(
    ...
    expect(alphabetIndex('We have a lot of rain in June.')).toBe(
      '23 5 8 1 22 5 1 12 15 20 15 6 18 1 9 14 9 14 10 21 14 5'
    );
    expect(alphabetIndex('Sixty-Four comes asking for bread.')).toBe(
      '19 9 24 20 25 6 15 21 18 3 15 13 5 19 1 19 11 9 14 7 6 15 18 2 18 5 1 4'
    );
    expect(alphabetIndex('The#b00k$is*in^fr0nt#0f!the_taBle.')).toBe(
    ...
    expect(alphabetIndex('The river stole the gods.')).toBe(
      '20 8 5 18 9 22 5 18 19 20 15 12 5 20 8 5 7 15 4 19'
    );
    expect(alphabetIndex('Wow, does that work?')).toBe(
    ...
    expect(alphabetIndex('Abstraction is often one floor above you.')).toBe(
