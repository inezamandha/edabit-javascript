...
[View on Edabit](https://edabit.com/challenge/LFdGBECCHWfyyZ7fg)

---

Given a sentence spelling out a word, return `true` if the spelled letters match the _word at the end of the string_, or `false` otherwise.
