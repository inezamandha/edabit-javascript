import removeVowels from './index';

describe('Javascript - Easy - 11', () => {
  test('Remove Every Vowel From a String', () => {
    expect(
      removeVowels(
    ...
    ).toEqual('Ths lctn s  ttl shm nd  trvsty. W r nt  dmcrcy!');
    expect(
      removeVowels('I have never seen a thin person drinking Diet Coke.')
    ).toEqual(' hv nvr sn  thn prsn drnkng Dt Ck.');
    expect(
      removeVowels(
    ...
    ).toEqual('Hppy Thnksgvng t ll--vn th htrs nd lsrs!');
    expect(
      removeVowels(
